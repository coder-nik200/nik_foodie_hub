...
//   const getItemLink = (item) => {
//     const id = item.variantId || item._id;
//     if (typeof id === "string") {
//       if (id.startsWith("sw_") || id.startsWith("sw"))
//         return `/foods/sweet/${id}`;
//       if (id.startsWith("dr_") || id.startsWith("dr"))
...
//     try {
//       await addToCartAPI(item._id || item.variantId);
//       fetchCart();
...
//     try {
//       await decrementCartItemAPI(item._id || item.variantId);
//       fetchCart();
//     } catch (err) {
//       toast.error(
...
//     try {
//       await removeFromCartAPI(item._id || item.variantId);
//       fetchCart();
...
//             <div className="flex-1">
//               <h2 className="font-semibold text-lg">{item.name}</h2>
//               <p className="text-sm text-gray-500 mt-1">{item.usp || ""}</p>
//               <p className="mt-3 text-lg font-bold text-green-600">
